...
class MY_Output extends CI_Output {
	...
	private $_title = "";
        private $_menu = array(); //garmaser Menu del templeate
...
//		get_instance()->session->set_flashdata("__messages", serialize($this->_messages));
	 ...
	 *
	 * @acceso publico
	 * @parametro $url ruta o direccion del link del sitio
         * @parametro $nombre nombre del link, el que se muestra en la interfaz
	 * @parametro $class estilo definico en el css del link
	 * @return bool
	 */
    
    public function set_menu($nombre='', $url='', $class=''){
        $this->_menu[]=array('url'=>$url, 'nombre'=>$nombre, 'class'=>$class);
    }  
}