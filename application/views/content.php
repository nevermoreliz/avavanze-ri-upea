        ...
        <div class="cs-hero_in">
            <div class="cs-hero_in_left">
                <div class="cs-hero_text">
                    <h1 class="cs-hero_title cs-white_color">The Best Beneficial Place to Collect , Buy and Sell NFT Marketplace</h1>
                    <div class="cs-hero_subtitle cs-medium cs-white_color">Secure and secret NFTs for gaming, entertainment, metaverse and data <br>management time capsules.</div>
