...
<section class="cs-hero cs-style4 cs-bg cs-center fondo-gradiente">
    <div class="container-fluid">
        <div class="cs-hero_in">
            <div class="cs-hero_in_left">
                <div class="cs-hero_text">
                    <h1 class="cs-hero_title cs-white_color">UNIDAD DE RELACIONES INTERNACIONALES</h1>
                    <div class="cs-hero_subtitle cs-medium cs-white_color">Visita el sitio web, de relaciones nacionales e internacionales DRNI de la UPEA<br>en busca de becas, convenios, movilidad</div>
...
<section class="aqui">
    <div class="container">
        <h2 class="cs-section_heading cs-style1 text-center">Top Seller in 1 Week</h2>
        ...
        <div class="row">
                ...
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_30.png" alt="Avatar"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_31.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>Debit alex</h3>
                                <p>12.3k</p>
                            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_32.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>Johnny E.</h3>
                                <p>1.3k</p>
                            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_33.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>Mark J.</h3>
                                <p>12.3k</p>
                            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_34.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>Hostetter R.</h3>
                                <p>5.3k</p>
                            </div>
                    ...
                    <div class="cs-card_right">
                        <ul class="cs-mp0">
                            ...
                            <li><i class="far fa-eye fa-fw"></i> 1.1K Views</li>
                        </ul>
                    </div>
                </div>
                <div class="cs-height_30 cs-height_lg_30"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_35.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>John Powell</h3>
                                <p>13.3k</p>
                            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_36.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>Austin R.</h3>
                                <p>13.3k</p>
                            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="cs-card cs-style5 cs-white_bg cs-box_shadow">
                    <div class="cs-card_left">
                        <div class="cs-card_media">
                            <div class="cs-card_img"><img src="../assets/img/avatar/avatar_37.png" alt="Avatar"></div>
                            <div class="cs-card_media_right">
                                <h3>Michael L.</h3>
                                <p>18.4k</p>
                            </div>
...
<section>
    <div class="container">
        <h2 class="cs-section_heading cs-style1 text-center">Explore By Catagory</h2>
        <div class="cs-height_45 cs-height_lg_45"></div>
                ...
                <div class="cs-slider_wrapper">
                    <div class="cs-slide">
                        <a href="#" class="cs-card cs-style6 cs-box_shadow cs-white_bg text-center">
                            <span class="cs-avatar"><img src="../assets/img/avatar/avatar_38.png" alt="Avatar"></span>
                            <div class="cs-card_info">
                    ...
                    <div class="cs-slide">
                        <a href="#" class="cs-card cs-style6 cs-box_shadow cs-white_bg text-center">
                            <span class="cs-avatar"><img src="../assets/img/avatar/avatar_39.png" alt="Avatar"></span>
                            <div class="cs-card_info">
                    ...
                    <div class="cs-slide">
                        <a href="#" class="cs-card cs-style6 cs-box_shadow cs-white_bg text-center">
                            <span class="cs-avatar"><img src="../assets/img/avatar/avatar_40.png" alt="Avatar"></span>
                            <div class="cs-card_info">
                    ...
                    <div class="cs-slide">
                        <a href="#" class="cs-card cs-style6 cs-box_shadow cs-white_bg text-center">
                            <span class="cs-avatar"><img src="../assets/img/avatar/avatar_41.png" alt="Avatar"></span>
                            <div class="cs-card_info">
                    ...
                    <div class="cs-slide">
                        <a href="#" class="cs-card cs-style6 cs-box_shadow cs-white_bg text-center">
                            <span class="cs-avatar"><img src="../assets/img/avatar/avatar_42.png" alt="Avatar"></span>
                            <div class="cs-card_info">
                    ...
                    <div class="cs-slide">
                        <a href="#" class="cs-card cs-style6 cs-box_shadow cs-white_bg text-center">
                            <span class="cs-avatar"><img src="../assets/img/avatar/avatar_43.png" alt="Avatar"></span>
                            <div class="cs-card_info">
...
<section>
    <div class="container">
        ...
        <div class="cs-slider cs-style1 cs-gap-20">
            <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="2" data-sm-slides="3" data-md-slides="4" data-lg-slides="5" data-add-slides="5">
                <div class="cs-slider_wrapper">
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="explore-details.html" class="cs-card_thumb cs-zoom_effect">
                                <img src="../assets/img/general/general_14.jpg" alt="Image" class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
                                <a href="#" class="cs-avatar cs-white_bg">
                    ...
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="explore-details.html" class="cs-card_thumb cs-zoom_effect">
                                <img src="../assets/img/general/general_15.jpg" alt="Image" class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
                                <a href="#" class="cs-avatar cs-white_bg">
                                    <div class="cs-avatar_images">
                                ...
                                <div class="cs-card_price">Current Bid: <b class="cs-primary_color">0.05 ETH 15/42</b></div>
                                <hr>
                                <div class="cs-card_footer">
                                    <span class="cs-card_btn_1" data-modal="#history_1">
                                        <i class="fas fa-redo fa-fw"></i>
                    ...
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="explore-details.html" class="cs-card_thumb cs-zoom_effect">
                                <img src="../assets/img/general/general_19.jpg" alt="Image" class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
                                <a href="#" class="cs-avatar cs-white_bg">
                                    <div class="cs-avatar_images">
                    ...
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="explore-details.html" class="cs-card_thumb cs-zoom_effect">
                                <img src="../assets/img/general/general_20.jpg" alt="Image" class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
                                <a href="#" class="cs-avatar cs-white_bg">
                                    <div class="cs-avatar_images">
                    ...
                    <div class="cs-slide">
                        <div class="cs-card cs-style4 cs-type1 cs-box_shadow cs-white_bg">
                            ...
                            <a href="explore-details.html" class="cs-card_thumb cs-zoom_effect">
                                <img src="../assets/img/general/general_21.jpg" alt="Image" class="cs-zoom_item">
                            </a>
                            <div class="cs-card_info">
                                <a href="#" class="cs-avatar cs-white_bg">
                                    <div class="cs-avatar_images">
...
<section>
    <div class="container">
        <h2 class="cs-section_heading cs-style1 text-center">The world's no.1 NFT platform for thousands of brands</h2>
        <div class="cs-height_45 cs-height_lg_45"></div>
    </div>
    <div class="cs-moving_carousel_1">
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/1.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/2.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/3.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/4.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/5.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/6.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/7.svg" alt="Partner logo"></div>
            </div>
        </div>
    </div>
    <div class="cs-height_30 cs-height_lg_30"></div>
    <div class="cs-moving_carousel_2">
        ...
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/9.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/10.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/11.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/12.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/13.svg" alt="Partner logo"></div>
            </div>
        </div>
        <div class="cs-single_moving_item">
            <div class="cs-partner">
                <div class="cs-partner_in cs-center cs-white_bg"><img src="http://thememarch.com/demo/html/enfhess-html/enfhess-dark/assets/img/partners/14.svg" alt="Partner logo"></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="cs-iconbox cs-style1 cs-white_bg">
                    ...
                    <div class="cs-iconbox_subtitle">It is a long established fact that a reader will be distracted by the readable</div>
                </div>
                <div class="cs-height_30 cs-height_lg_30"></div>
            </div>
            <div class="col-lg-3 col-sm-6">
...
<section>
    <div class="container">
        <div class="cs-cta cs-style2 text-center cs-accent_bg">
            <h2 class="cs-cta_title cs-white_color_8">Join our biggest NFTs platform</h2>
            <div class="cs-cta_subtitle cs-white_color_8">Exercitation veniam consequat sunt nostrud amet. It is a long <br>established fact that a reader</div>
            <a href="register.html" class="cs-btn cs-style1 cs-btn_lg cs-color2"><span>Sign Up</span></a>
        </div>
    </div>
</section>
<!-- End CTA -->
