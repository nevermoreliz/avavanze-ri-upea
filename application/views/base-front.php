...
<!-- Mirrored from thememarch.com/demo/html/enfhess-html/enfhess-dark/light-mode/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Nov 2022 08:34:15 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php base_url('../assets/css/plugins/fontawesome.min.css') ?>"> -->
    <link href="<?= base_url('assets/public_html/front_uno/assets/css/plugins/fontawesome.min.css') ?>" rel='stylesheet' type='text/css'>

    <!-- <link rel="stylesheet" href="<?php base_url('../assets/css/plugins/bootstrap.min.css') ?>"> -->
    <link href="<?= base_url('assets/public_html/front_uno/assets/css/plugins/bootstrap.min.css') ?>" rel='stylesheet' type='text/css'>
    <!-- <link rel="stylesheet" href="<?php base_url('../assets/css/plugins/slick.css') ?>"> -->
    <link href="<?= base_url('assets/public_html/front_uno/assets/css/plugins/slick.css') ?>" rel='stylesheet' type='text/css'>
...
<body>
            ...
            <div class="cs-modal_container_in">
                ...
                <div class="cs-history">
                    ...
                    <ul class="cs-history_list">
                        ...
                        <li>
                            <div class="cs-media cs-style1">
                                <div class="cs-media_thumb"><img src="../assets/img/avatar/avatar_3.png" alt=""></div>
                                <div class="cs-media_info">
    ...
    <script src="<?php echo base_url('assets/public_html/front_uno/assets/js/plugins/jquery-3.6.0.min.js'); ?>"></script>
    <!-- <script src="../assets/js/plugins/isotope.pkg.min.js"></script> -->
    <script src="<?php echo base_url('assets/public_html/front_uno/assets/js/plugins/isotope.pkg.min.js'); ?>"></script>
